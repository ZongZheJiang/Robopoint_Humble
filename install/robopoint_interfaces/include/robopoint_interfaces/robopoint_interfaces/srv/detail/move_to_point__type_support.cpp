...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveToPoint_Request_message_member_array[2] = {
  {
    "x",  // name
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveToPoint_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robopoint_interfaces::srv::MoveToPoint_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
