...
#include "robopoint_interfaces/srv/detail/query__rosidl_typesupport_fastrtps_c.h"
...
using _Query_Request__ros_msg_type = robopoint_interfaces__srv__Query_Request;
...
size_t get_serialized_size_robopoint_interfaces__srv__Query_Request(
  const void * untyped_ros_message,
...
static uint32_t _Query_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robopoint_interfaces__srv__Query_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robopoint_interfaces
size_t max_serialized_size_robopoint_interfaces__srv__Query_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robopoint_interfaces__srv__Query_Request;
    is_plain =
      (
...
static size_t _Query_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robopoint_interfaces__srv__Query_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query_Request)() {
...
using _Query_Response__ros_msg_type = robopoint_interfaces__srv__Query_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robopoint_interfaces
size_t get_serialized_size_robopoint_interfaces__srv__Query_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Query_Response__ros_msg_type * ros_message = static_cast<const _Query_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robopoint_interfaces__srv__Query_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robopoint_interfaces
size_t max_serialized_size_robopoint_interfaces__srv__Query_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robopoint_interfaces__srv__Query_Response;
    is_plain =
      (
...
static size_t _Query_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robopoint_interfaces__srv__Query_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query_Response)() {
...
// already included above
// #include "robopoint_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robopoint_interfaces/srv/query.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query)() {
