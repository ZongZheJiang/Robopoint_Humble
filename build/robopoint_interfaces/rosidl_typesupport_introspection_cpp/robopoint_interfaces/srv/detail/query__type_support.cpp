...
{
  new (message_memory) robopoint_interfaces::srv::Query_Request(_init);
}

void Query_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robopoint_interfaces::srv::Query_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Query_Request_message_member_array[1] = {
  {
    ...
    offsetof(robopoint_interfaces::srv::Query_Request, query),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Query_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(robopoint_interfaces::srv::Query_Request),
...
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_introspection_cpp::Query_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query_Request)() {
  return &::robopoint_interfaces::srv::rosidl_typesupport_introspection_cpp::Query_Request_message_type_support_handle;
}
...
void Query_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) robopoint_interfaces::srv::Query_Response(_init);
}

void Query_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robopoint_interfaces::srv::Query_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Query_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robopoint_interfaces::srv::Query_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Query_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(robopoint_interfaces::srv::Query_Response),
...
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_introspection_cpp::Query_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query_Response)() {
  return &::robopoint_interfaces::srv::rosidl_typesupport_introspection_cpp::Query_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Query_service_members = {
  ...
  // see get_service_type_support_handle<robopoint_interfaces::srv::Query>()
...
get_service_type_support_handle<robopoint_interfaces::srv::Query>()
{
  ...
  auto service_type_support =
    &::robopoint_interfaces::srv::rosidl_typesupport_introspection_cpp::Query_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<robopoint_interfaces::srv::Query>();
}
