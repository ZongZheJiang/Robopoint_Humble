...
static const _Query_Request_type_support_symbol_names_t _Query_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robopoint_interfaces, srv, Query_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robopoint_interfaces, srv, Query_Request)() {
  return &::robopoint_interfaces::srv::rosidl_typesupport_c::Query_Request_message_type_support_handle;
}
...
static const _Query_Response_type_support_symbol_names_t _Query_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robopoint_interfaces, srv, Query_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robopoint_interfaces, srv, Query_Response)() {
  return &::robopoint_interfaces::srv::rosidl_typesupport_c::Query_Response_message_type_support_handle;
}
...
static const _Query_type_support_symbol_names_t _Query_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robopoint_interfaces, srv, Query)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robopoint_interfaces, srv, Query)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robopoint_interfaces, srv, Query)() {
  return &::robopoint_interfaces::srv::rosidl_typesupport_c::Query_service_type_support_handle;
}
