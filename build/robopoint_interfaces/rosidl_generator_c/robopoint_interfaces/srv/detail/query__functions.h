...
#ifndef ROBOPOINT_INTERFACES__SRV__DETAIL__QUERY__FUNCTIONS_H_
#define ROBOPOINT_INTERFACES__SRV__DETAIL__QUERY__FUNCTIONS_H_
 ...
 * )) before or use
 * robopoint_interfaces__srv__Query_Request__create()
 ...
 * calls
 * robopoint_interfaces__srv__Query_Request__init().
...
/**
 * It calls
 * robopoint_interfaces__srv__Query_Request__fini()
 ...
 * robopoint_interfaces__srv__Query_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robopoint_interfaces__srv__Query_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * robopoint_interfaces__srv__Query_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robopoint_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robopoint_interfaces__srv__Query_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robopoint_interfaces
...
/**
 * It calls
 * robopoint_interfaces__srv__Query_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robopoint_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robopoint_interfaces__srv__Query_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robopoint_interfaces
...
/**
 * It calls
 * robopoint_interfaces__srv__Query_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOPOINT_INTERFACES__SRV__DETAIL__QUERY__FUNCTIONS_H_
