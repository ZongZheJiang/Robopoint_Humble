...
static const _Query_Request_type_support_symbol_names_t _Query_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query_Request)),
  }
};
...
get_message_type_support_handle<robopoint_interfaces::srv::Query_Request>()
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_cpp::Query_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robopoint_interfaces, srv, Query_Request)() {
  return get_message_type_support_handle<robopoint_interfaces::srv::Query_Request>();
}
...
static const _Query_Response_type_support_symbol_names_t _Query_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<robopoint_interfaces::srv::Query_Response>()
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_cpp::Query_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robopoint_interfaces, srv, Query_Response)() {
  return get_message_type_support_handle<robopoint_interfaces::srv::Query_Response>();
}
...
static const _Query_type_support_symbol_names_t _Query_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, Query)),
  }
};
...
get_service_type_support_handle<robopoint_interfaces::srv::Query>()
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_cpp::Query_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, robopoint_interfaces, srv, Query)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<robopoint_interfaces::srv::Query>();
}
