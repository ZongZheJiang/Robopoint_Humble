...
#include "robopoint_interfaces/srv/detail/query__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robopoint_interfaces::srv::Query_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robopoint_interfaces::srv::Query_Request & ros_message)
{
  // Member: query
  cdr >> ros_message.query;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robopoint_interfaces::srv::Query_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robopoint_interfaces::srv::Query_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robopoint_interfaces::srv::Query_Request *>(
    untyped_ros_message);
...
{
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query_Request)() {
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robopoint_interfaces
cdr_serialize(
  const robopoint_interfaces::srv::Query_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robopoint_interfaces::srv::Query_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robopoint_interfaces::srv::Query_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robopoint_interfaces::srv::Query_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robopoint_interfaces::srv::Query_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query_Response)() {
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query_Response__handle;
}
...
{
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, Query)() {
  return &robopoint_interfaces::srv::typesupport_fastrtps_cpp::_Query__handle;
}
